...
\cventry{Fevereiro 2022--Setembro 2022}{Desenvolvedor Backend}{}{Sólides}{}{Manutenção e correção de bugs, além de construção de novas soluções no sistema interno da empresa em Ruby on Rails. Eu trabalhei desenvolvendo novas funcionalidades na nova versão da API e migrando funcionalidades já existentes para a nova versão. A maior parte do tempo estive na equipe de manutenção do código, trabalhando junto com o time de suporte. \newline{}
Tarefas realizadas:
\begin{itemize}
...
\cventry{Setembro 2022--Hoje}{Desenvolvedor Backend}{}{GoDaddy}{}{Experiência em empresa americana com time de diversos países com a comunicação toda em inglês. Construí de novas funcionalidades no sistema interno de marketplace, realizando novas funcões com as integrações já existentes com outros sistemas. Manutenção do sistema junto a equipe de suporte e melhorando os testes automatizados. \newline{}
Tarefas realizadas:
\begin{itemize}
    \item Desenvolvimento de novas funcionalidades;
    \item Correção de bugs e investigação de problemas;
    \item Migração da documentação para novo padrão usando o Github Pages;
    \item Comunicação com APIs externas;
    \item Escrita de novos testes automatizados e melhoria dos atuais usando RSpec;
    \item Frameworks e tecnologias utilizadas:
      \begin{itemize}
          \item Ruby on Rails;
          \item RSpec;
