...
\cventry{Abril 2019--Novembro 2019}{Desenvolvedor FullStack}{}{Ownee}{}{Desenvolvimento e melhoria da aplicação web (Ruby on Rails e Vuejs). Construindo novas funcionalidades, otimizando buscas no banco de dados, comunicando com APIs externas e criando componentes novos tanto no backend como no frontend. Foi feito uma refatoração completa, alterando a arquitetura e seus componentes, aonde atuei ativamente na modelagem da nova versão.  \newline{}
Tarefas realizadas:
\begin{itemize}
