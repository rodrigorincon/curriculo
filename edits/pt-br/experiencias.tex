...
\cventry{Fevereiro 2022--Setembro 2022}{Desenvolvedor Backend}{}{Sólides}{}{Construção de novas soluções e manutenção no sistema Ruby on Rails da empresa. Eu trabalhei desenvolvendo novas funcionalidades na nova versão da API e migrando funcionalidades já existentes para a nova versão. A maior parte do tempo estive na equipe de manutenção do código, trabalhando junto com o time de suporte. \newline{}
Tarefas realizadas:
\begin{itemize}
